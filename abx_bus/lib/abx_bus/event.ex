defmodule AbxBus.Event do
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      Module.put_attribute(__MODULE__, :abx_event_meta, true)
      Module.register_attribute(__MODULE__, :abx_result_type, persist: true)
      Module.put_attribute(__MODULE__, :abx_result_type, unquote(result_type))
      Module.register_attribute(__MODULE__, :abx_event_version, persist: true)
      Module.put_attribute(__MODULE__, :abx_event_version, unquote(version))
