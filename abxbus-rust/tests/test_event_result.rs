...
fn test_eventresultslist_returns_filtered_values_by_default_and_can_return_raw_values_with_include()
{
    ...
    let default_values = block_on(event.event_results_list_with_options(
        EventResultOptions {
            raise_if_any: false,
            raise_if_none: true,
            include: None,
...
fn test_eventresultslist_supports_include_raise_if_any_raise_if_none_arguments() {
    ...
    let empty_error = block_on(none_event.event_results_list_with_options(
        EventResultOptions {
            raise_if_any: false,
            raise_if_none: true,
            include: None,
    ...
    let empty_values = block_on(none_event.event_results_list_with_options(
        EventResultOptions {
            raise_if_any: false,
            raise_if_none: false,
            include: None,
...
fn test_event_result_all_error_options_contract() {
    ...
    let none_list_error = block_on(event.event_results_list_with_options(
        EventResultOptions {
            raise_if_any: false,
            raise_if_none: true,
            include: None,
