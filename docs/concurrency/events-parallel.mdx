...
func main() {
	...
	bus.On("ParallelEvent", "handler", func(ctx context.Context, event *abxbus.BaseEvent) (any, error) {
		mu.Lock()
		inFlight++
...
bus.on_sync("ParallelEvent", "handler", |_event| Ok(serde_json::Value::Null));
bus.emit_base(BaseEvent::new("ParallelEvent", Default::default()));
bus.emit_base(BaseEvent::new("ParallelEvent", Default::default()));
