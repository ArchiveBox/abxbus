...
func main() {
	...
	bus.OnEventName("CompletionEvent", "fast_handler", func(event *abxbus.BaseEvent) (any, error) {
	...
	bus.OnEventName("CompletionEvent", "slow_handler", func(event *abxbus.BaseEvent) (any, error) {
	...
	event := bus.EmitEventName("CompletionEvent", nil)
