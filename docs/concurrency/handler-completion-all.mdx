...
bus.on_sync("CompletionEvent", "fast_handler", |_event| Ok(json!("fast")));
bus.on_sync("CompletionEvent", "slow_handler", |_event| Ok(json!("slow")));

let event = bus.emit_base(BaseEvent::new("CompletionEvent", Default::default()));
