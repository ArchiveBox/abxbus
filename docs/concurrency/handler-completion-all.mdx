...
func main() {
	...
	bus.On("CompletionEvent", "fast_handler", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
	...
	bus.On("CompletionEvent", "slow_handler", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
