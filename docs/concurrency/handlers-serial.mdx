...
func main() {
	...
	bus.On("HandlerEvent", "h1", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
	...
	bus.On("HandlerEvent", "h2", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
