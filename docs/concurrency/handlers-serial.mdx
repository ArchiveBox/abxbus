...
func main() {
	...
	bus.OnEventName("HandlerEvent", "h1", func(event *abxbus.BaseEvent) (any, error) {
	...
	bus.OnEventName("HandlerEvent", "h2", func(event *abxbus.BaseEvent) (any, error) {
	...
	event := bus.EmitEventName("HandlerEvent", nil)
