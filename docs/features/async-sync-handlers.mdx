...
func main() {
	...
	bus.OnEventName("WorkEvent", "bare_handler", bareHandler, nil)
	bus.OnEventName("WorkEvent", "static_style_handler", StaticStyleHandler, nil)
	bus.OnEventName("WorkEvent", "instance_handler", handlers.InstanceHandler, nil)
}
```
