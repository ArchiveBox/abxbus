...
func main() {
	...
	bus.On("JobEvent", "on_job", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
...
bus.On("SlowEvent", "on_slow", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
...
bus.On("FastEvent", "on_fast", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
	trace = append(trace, fmt.Sprintf("start:%s:%s", event.EventType, event.Payload["name"]))
