...
func main() {
	...
	auth.bus.On("UserCreatedEvent", "on_user_created", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
		return fmt.Sprintf("auth-ok:%s", event.Payload["user_id"]), nil
	}, nil)
	billing.bus.On("UserCreatedEvent", "on_user_created", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
		return fmt.Sprintf("billing-ok:%s", event.Payload["user_id"]), nil
	}, nil)

	auth.bus.On("*", "forward_to_relay", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
		return relay.bus.Emit(event), nil
	}, nil)
	relay.bus.On("*", "forward_to_billing", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
...
// uni-directional
left.On("*", "forward_to_right", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
	return right.Emit(event), nil
}, nil)

// bi-directional (add reverse path)
right.On("*", "forward_to_left", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
...
busC.On("*", "forward_to_a", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
