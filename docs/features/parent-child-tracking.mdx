...
func main() {
	...
	bus.On("CheckoutEvent", "on_checkout", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
	...
	bus.On("ReserveInventoryEvent", "on_reserve", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
		return fmt.Sprintf("reserve:%s", event.Payload["order_id"]), nil
	}, nil)

	bus.On("ChargeCardEvent", "on_charge", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
		orderID := event.Payload["order_id"].(string)
	...
	bus.On("FraudCheckEvent", "on_fraud", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
		return fmt.Sprintf("fraud-ok:%s", event.Payload["order_id"]), nil
	}, nil)
	bus.On("SendReceiptEvent", "on_receipt", func(event *abxbus.BaseEvent, ctx context.Context) (any, error) {
