...
- Concurrency modes, overrides, and timeout behavior:
  ...
  - [`abxbus-ts/examples/concurrency_options.ts`](https://github.com/pirate/bbus/blob/main/abxbus-ts/examples/concurrency_options.ts)
- Immediate execution (queue-jump) behavior:
  - [`examples/immediate_event_processing.py`](https://github.com/pirate/bbus/blob/main/examples/immediate_event_processing.py)
  - [`abxbus-ts/examples/immediate_event_processing.ts`](https://github.com/pirate/bbus/blob/main/abxbus-ts/examples/immediate_event_processing.ts)
- Forwarding between buses:
  ...
  - [`abxbus-ts/examples/forwarding_between_busses.ts`](https://github.com/pirate/bbus/blob/main/abxbus-ts/examples/forwarding_between_busses.ts)
- Parent-child lineage tracking:
  - [`examples/parent_child_tracking.py`](https://github.com/pirate/bbus/blob/main/examples/parent_child_tracking.py)
  - [`abxbus-ts/examples/parent_child_tracking.ts`](https://github.com/pirate/bbus/blob/main/abxbus-ts/examples/parent_child_tracking.ts)
- Tree logs with nested timeout outcomes:
  ...
  - [`abxbus-ts/examples/log_tree_demo.ts`](https://github.com/pirate/bbus/blob/main/abxbus-ts/examples/log_tree_demo.ts)
