...
```python
from abxbus import NATSEventBridge
...
```ts
import { NATSEventBridge } from 'abxbus'
...
```python
from abxbus import EventBus, NATSEventBridge
...
```ts
import { EventBus, NATSEventBridge } from 'abxbus'
