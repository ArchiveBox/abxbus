...
| Runtime | 1 bus x 50k events x 1 handler | 500 buses x 100 events x 1 handler | 1 bus x 1 event x 50k parallel handlers | 1 bus x 50k events x 50k one-off handlers | Worst case (forwarding + queue-jump + timeouts) |
| --- | --- | --- | --- | --- | --- |
| Go | `0.007ms/event` | `0.006ms/event` | `0.083ms/handler` | `0.009ms/event` | `0.028ms/event` |
