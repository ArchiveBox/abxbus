...
`abxbus-rust` is a native Rust crate in this repository.
...
`abxbus-go` is a native Go module in this repository.

- Module path: `github.com/ArchiveBox/abxbus/abxbus-go`
- Tested with `go test ./...`
- Cross-runtime JSON roundtrips use `abxbus-go/cmd/abxbus-go-roundtrip`
